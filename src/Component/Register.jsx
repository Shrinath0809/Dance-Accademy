  ...
  return (
    ...
    <div className='div'>
      <form action="" className='frm'>
          ...
          <input type={(viewPassword===false)? "password":"text"} name="password" id="password" value={password} placeholder='password'  className='in'onChange={handleData}/>{
                (viewPassword===false)? <AiFillEyeInvisible className='icon' onClick={handlePassword} />:<AiFillEye className='icon' onClick={handlePassword} />
          }
          ...
          <input type="text" name="phone" id="phone" value={phone} placeholder='phone' className='in' onChange={handleData} />
           ...
           <label htmlFor="male" className='gender' >Male</label>
            ...
            <label htmlFor="female" className='gender' >Female</label></div>
