...
const Login = () => {
  ...
  return (
    ...
    <label htmlFor="">Password</label>
      <input type={(viewPassword===false)? "password":"text"} name='password' value ={password} onChange={handleChange} />{
                (viewPassword===false)? <AiFillEyeInvisible className='login-icon' onClick={handlePassword} />:<AiFillEye className='login-icon' onClick={handlePassword} />
      }
    </div>
    <div>
      <button>LOGIN</button>
